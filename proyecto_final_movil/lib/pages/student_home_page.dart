        ...
        children: [
          ...
          Card(
            child: ListTile(
              ...
              trailing: const Chip(label: const Text('En revisión'), backgroundColor: Colors.blue),
            ),
          ),
          const SizedBox(height: 12),
          ...
          Card(
            child: ListTile(
              ...
              trailing: const Chip(label: const Text('Preseleccionado'), backgroundColor: Colors.orange),
            ),
          ),
          const SizedBox(height: 12),
          ...
          Card(
            child: ListTile(
              ...
              trailing: const Chip(label: const Text('Rechazado'), backgroundColor: Colors.grey),
            ),
          ),
        ],
      ),
